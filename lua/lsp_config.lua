-- LSP Configuration using new vim.lsp.config (Neovim 0.11+)
-- This replaces the deprecated nvim-lspconfig plugin
...
-- Configure clangd using the new vim.lsp.config system
vim.lsp.config('clangd', {
  on_attach = on_attach
})

-- Enable the clangd LSP server
